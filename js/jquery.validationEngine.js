 ...
 */
 (function($) {
	...
	var methods = {
      ...
      if (options.clearValidationIfEmpty && !(field.val() + '').length) {
        methods._closePrompt(field);
        methods._handleStatusCssClasses(field, options, true);
        return null;
      }
		...
		* @private
		*/
    _handleStatusCssClasses: function (field, options, clearCssClasses) {
